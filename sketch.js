...
boxleftBody=Bodies.rectangle(900,600,20,100,{isStatic:false} );
World.add(world,boxleftBody);

boxBase=createSprite(800,660,200,20);
boxBase.shapeColor="white";

boxBottomBody=Bodies.rectangle(800,600,200,20,{isStatic:false} )
World.add(world,boxBottomBody);

boxRightSprite=createSprite(700,600,20,130);
boxRightSprite.shapeColor="white";

boxRightBody=Bodies.rectangle(700,600,0,0,{isStatic:false} );
...
function keyPressed() {
 ...
 if (keyCode === UP_ARROW) {
  Matter.Body.applyForce(paperobject.body, paperobject.position,{x:110,y:-110}) 
  }
}
